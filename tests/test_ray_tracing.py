import numpy as np
from openptv_python import ray_tracing
from openptv_python.calibration import Calibration, MultiMediaParams

def test_ray_tracing():
    # Test Case 1
    x, y = 0, 0
    cal = Calibration()# create Variable for cal with necessary data
    mm = MultiMediaParams() # create an object for mm with necessary data
