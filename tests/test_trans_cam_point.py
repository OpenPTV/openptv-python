...
from openptv_python.multimed import trans_Cam_Point, back_trans_Point
from openptv_python.calibration import Glass, Exterior
...
class TestTransformFunctions(unittest.TestCase):
    ...
    def test_trans_Cam_Point(self):
        ...
        expected_pos_t = np.array([8.77496439, 0., 4.48864969])
        expected_cross_p = np.array([8, 9, 10])
        expected_cross_c = np.array([9.49152542, 2., 3.])
