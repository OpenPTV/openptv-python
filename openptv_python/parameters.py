...
class ControlPar(Parameters):
    ...
    hp_flag: np.int32 = field(default_factory=np.int32)
    all_cam_flag: np.int32 = field(default_factory=np.int32)
    tiff_flag: np.int32 = field(default_factory=np.int32)
    ...
    chfield: np.int32 = field(default_factory=np.int32)
    ...
    def from_file(cls, filename: Path):
        ...
        with open(filename, "r", encoding="utf-8") as par_file:
            ...
            ret.hp_flag = np.int32(par_file.readline().strip())
            ret.all_cam_flag = np.int32(par_file.readline().strip())
            ret.tiff_flag = np.int32(par_file.readline().strip())
            ...
            ret.chfield = np.int32(par_file.readline().strip())
            ret.mm.n1 = np.float64(par_file.readline().strip())
            ret.mm.n2[0] = np.float64(par_file.readline().strip())
            ret.mm.n3 = np.float64(par_file.readline().strip())
            ret.mm.d[0] = np.float64(par_file.readline().strip())
